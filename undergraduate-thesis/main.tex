...
\BITSetup{
  ...
  info = {
    ...
    % 如需要换行，则用 “\\” 符号分割。
    title = 离散数学在图持续学习领域的应用,
    titleEn = {The Application of Discrete Mathematics in the Field of Graph Continual Learning},
    school = 计算机学院,
    major = 人工智能,
    class = 07182401,
    author = 王浩恩 1120242340\\庞项祯 1120241349\\杨佳车 1120240660,
    supervisor = 张春霞,
    keywords = {离散数学；图持续学习；图编辑距离；动态建模；经验回放；拓扑正则化},
    keywordsEn = {Discrete Mathematics; Graph Continual Learning; Graph Edit Distance; Dynamic Modeling; Experience Replay; Topological Regularization},
...
% 重新定义章节编号格式
\renewcommand{\thechapter}{\arabic{chapter}}  % 将章节号改为阿拉伯数字
\renewcommand{\thesection}{\thechapter.\arabic{section}}
\renewcommand{\thesubsection}{\thesection.\arabic{subsection}}

% 设置章节标题格式（保持原来的对齐方式，只修改编号格式）
\titleformat{\chapter}
  {\normalfont\heiti\zihao{3}\bfseries\raggedright}
  {\thechapter}  % 使用修改后的章节号
  {1em}
  {}

\titleformat{\section}
  {\normalfont\heiti\zihao{4}\bfseries\raggedright}
  {\thesection}
  {1em}
  {}
